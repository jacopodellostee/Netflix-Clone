...
export default function Favorites() {
    ...
    if (!favorites || favorites.length === 0) {
        return (
            <div className="w-full min-h-screen bg-black text-white flex flex-col items-center justify-center">
                <h2 className="text-3xl font-bold mb-4">La tua lista è vuota</h2>
                <p className="text-gray-400 text-lg">
                    Non hai ancora aggiunto nulla ai preferiti. 
                    Torna alla Home per aggiungere film e serie TV!
                </p>
            </div>
        )
    }
    ...
    return (
        <div className="w-full min-h-screen bg-black text-white px-4 md:px-8 py-24">
            <h1 className="text-3xl md:text-4xl font-bold mb-12 text-center">La mia Lista</h1>
